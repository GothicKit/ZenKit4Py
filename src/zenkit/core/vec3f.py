...
class Vec3f(Structure):
    ...
    def __gt__(self, other: "Vec3f") -> bool:
        """
    ...
    def __ge__(self, other: "Vec3f") -> bool:
        """
    ...
    def __add__(self, other: Union["Vec3f", float, int]) -> "Vec3f":
        ...
        Returns:
            A new Vec3f instance representing the sum.
    ...
    def __sub__(self, other: Union["Vec3f", float, int]) -> "Vec3f":
        """
        ...
        Returns:
            A new Vec3f instance representing the difference.
    ...
    def __mul__(self, other: Union["Vec3f", float, int]) -> "Vec3f":
        """
        ...
        Returns:
            A new Vec3f instance representing the product.
    ...
    def __truediv__(self, other: Union["Vec3f", float, int]) -> "Vec3f":
        ...
        Returns:
            A new Vec3f instance representing the quotient.
    ...
    def normalize(self) -> "Vec3f":
        ...
        Returns:
            A new Vec3f instance representing the normalized Vector.
        """
        l = self.length()
        if l > 0:
            return self / l
