...
from ctypes import c_void_p, c_char_p, c_int, c_uint, c_float, c_bool
...
class Material:
    ...
    @property
    def name(self) -> str:
        DLL.ZkMaterial_getName.restype = c_char_p
        return DLL.ZkMaterial_getName(self._handle).decode("utf-8")
    ...
    def texture(self) -> str:
        DLL.ZkMaterial_getTexture.restype = c_char_p
        return DLL.ZkMaterial_getTexture(self._handle).decode("utf-8")
    ...
    def detail_object(self) -> str:
        DLL.ZkMaterial_getDetailObject.restype = c_char_p
        return DLL.ZkMaterial_getDetailObject(self._handle).decode("utf-8")
